...
def animation_function(i):
    ...
    #Turn on grid
    pyp.grid(linestyle='-', linewidth='0.5', color='gray')
    pyp.xlabel('Time (1 unit - 10 secs)')
    pyp.ylabel('CPU Utilization')
...
pyp.savefig('CPU_graph.png',dpi=300,bbox_inches='tight')

#Graph generated and saved to CPU_graph.png
print('-- Graph generated and saved as CPU_graph.png -- \n')
